...
store.dispatch(buyCake()) // passing 'action creator'
store.dispatch({type:BUY_CAKE}) //  directly passing type
...
// after 'unsubscribe' we can't do changes,
// if you want to so changes in state then do 'subscribe' again
const unsubscribe2 = store.subscribe(() => console.log('Updated',store.getState()))
